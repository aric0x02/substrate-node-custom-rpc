...
use crate::{balance::BalancesAdapter, storage::*};
...
mod boxed {
	...
	use crate::{balance::boxed::BalancesAdapter, event::DefaultEventHandler, storage::boxed::*};
	...
	impl StateAccess for VmWrapperTy {
		...
		fn get_module_abi(&self, module_id: &[u8]) -> Result<Option<sp_std::vec::Vec<u8>>, Error> {
