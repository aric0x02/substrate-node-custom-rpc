		...
		fungibles::Inspect<T::AccountId, Balance = BalanceOf<T>, AssetId = T::CurrencyId>,
{
	...
	fn total_issuance(currency_id: Self::AssetId) -> Self::Balance {
		match currency_id {
			...
			_ =>
				<T::MultiCurrency as fungibles::Inspect<T::AccountId>>::total_issuance(currency_id),
		}
	}
	...
	fn minimum_balance(currency_id: Self::AssetId) -> Self::Balance {
		match currency_id {
			...
			_ =>
				<T::MultiCurrency as fungibles::Inspect<T::AccountId>>::minimum_balance(currency_id),
		}
	}
	...
	fn balance(currency_id: Self::AssetId, who: &T::AccountId) -> Self::Balance {
		match currency_id {
			...
			_ => <T::MultiCurrency as fungibles::Inspect<T::AccountId>>::balance(currency_id, who),
		}
	}
